...
import { addProjectContext } from '../contexts/ContexstShare';

const Add = () => {
  const {addProjectResponse,setAddProjectResponse} = useContext(addProjectContext)
  const [preview,setPreview] = useState("")
  const [uplaodFileStatus,setUploadFileStatus] = useState(false)
          ...
          <div className="row align-items-center">
            <div className="col-lg-4">
              <label>
                ...
                <img className='img-fluid' src={preview?preview:uploadProjectImg} alt="" />
              </label>
              { !uplaodFileStatus && <div className='text-warning fw-bolder'>*Upload Only the following file types (jpeg, jpg, png) here!!!</div> }
            </div>
